...
struct AppColors {
    static let green500 = Color(red: 0x4C/255, green: 0xAF/255, blue: 0x50/255)
    static let blue500 = Color(red: 0x21/255, green: 0x96/255, blue: 0xF3/255)
    static let red500 = Color(red: 0xF4/255, green: 0x43/255, blue: 0x36/255)
