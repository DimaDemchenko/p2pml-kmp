...
class HlsPlaylistParserTest {
    ...
    @Test
    fun testCommentBetweenStreamInfAndUriIsNotTreatedAsUri() {
        val manifest = """
            #EXTM3U
            #EXT-X-STREAM-INF:BANDWIDTH=800000,RESOLUTION=640x360
            # generated by packager v2.1
            video/360p.m3u8
        """.trimIndent()
        ...
        assertEquals("http://example.com/video/360p.m3u8", playlist.variants.single().url.absolute)

        // The comment is preserved in place; the real URI line is the one rewritten.
        assertTrue(result.rewrittenManifest.contains("# generated by packager v2.1"))
        assertTrue(result.rewrittenManifest.contains("rewritten-var-video/360p.m3u8"))
        assertFalse(result.rewrittenManifest.contains("rewritten-var-# generated"))
    }
